...
INPUT = '/mnt/hdd/home/tmp/los/data/original'
OUTPUT = '/mnt/hdd/home/tmp/los/data/maps/20210119_cls_maps'

files = [join(INPUT, f) for f in listdir(INPUT)]
shuffle(files)
for f in files:
    ...
    _pool = discarray(f'{OUTPUT}/{basename(f)}.bin', mode="w+",
    ...
    plt.savefig(f'{OUTPUT}/{basename(f)}.png')
    # plt.show()
