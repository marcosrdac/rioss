...
def mwa(img, wr=1):
    '''
    Calculates moving window average over padded input array.
    '''
    ws = 2*wr+1
    return(
            convolve2d(img,
...
def mcwa(img, r_o=5, r_i=0):
    '''
    Calculates moving circular window average over padded input array.
    '''
...
def mwsd(img, wr=1):
    '''
    Calculates moving window standard deviation of an arry (img) padded copy.
    '''
